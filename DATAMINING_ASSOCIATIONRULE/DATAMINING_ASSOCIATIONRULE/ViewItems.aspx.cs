...
namespace DATAMINING_ASSOCIATIONRULE
{
    public partial class ViewItems : System.Web.UI.Page
    {
                        ...
                        try
                        {
                            while (count < 3)
                            {
                                ...
                                if (k + cnt < tab.Rows.Count)
                                {
                                    ...
                                    // Button Row - Removed cart image, only text links
                                    int totalquantity = int.Parse(tab.Rows[k + cnt]["Quantity"].ToString());
                                    ...
                                    txt.ColumnSpan = 2; // Take full width since cart image is removed
                                    txt.Controls.Add(li);
        ...
        {
            // Last page functionality can be implemented here if needed
        }
                        ...
                        try
                        {
                            while (count < 3)
                            {
                                ...
                                if (k + cnt < tab.Rows.Count)
                                {
                                    ...
                                    {
                                        li1.Enabled = false;
                                        li1.Text = "<font size='2px'>Out of Stock</font>";
                                    }
                        ...
                        try
                        {
                            while (count < 3)
                            {
                                ...
                                if (k + cnt < tab.Rows.Count)
                                {
                                    ...
                                    // Button Row - Removed cart image, only text links
                                    int totalquantity = int.Parse(tabItemDetails.Rows[0]["Quantity"].ToString());
                                    ...
                                    {
                                        li2.Enabled = false;
                                        li2.Text = "<font size='2px'>Out of Stock</font>";
                                    }
